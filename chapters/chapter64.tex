...
"A Gryffindor? But if courage is the mark of Gryffindor, Severus, you really should{\el}"
...
"Have you seen Harry Potter, Minerva? Because if you have, I must insist{\el}"
...
"No, I have performed my usual magic. I am extraordinary, but this wand{\el} no. I feel no difference between this wand and the one I procured from Ollivander all those year ago." The Dark Lord paused. "No difference."
...
Nothing was more important. The hands that blocked life from leaving left their struggle, and life poured forth even as the hands gripped fabric and the mouth found words, "Take{\el} it{\el} take{\el}" and the gushing forth of his soul, his very being, as fatal as the gushing forth of his blood, drowned the last of the words.

Then she came. He had missed her for so long. "Look{\el} at{\el} me{\el}" he whispered through the blood in his throat. Her eyes smiled down into his, and he knew that he had done what he was supposed to do, that the task was accomplished, the duty fulfilled, and he was forgiven. He gazed into the peace of the well-loved eyes and relaxed, and let go, and let himself sink into the warm, welcoming darkness. And then{\el}

{\el} there was nothing.

\sbreak\cleartorecto\sbreak
