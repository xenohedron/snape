...
\usepackage[bookmarks=true,unicode=true,pdfborder={0 0 0},
	pdftitle={A Difference in the Family: The Snape Chronicles},
	pdfauthor={Rannaro}, breaklinks={true},
	pdfkeywords={Harry Potter, Snape},pdfencoding=auto
...
%
\setlength{\emergencystretch}{.08\textwidth}
% If a paragraph cannot be typeset without compromises, try wider line spacing
%
\clubpenalty=95 % Mildly discourages first line of paragraph on previous page
\widowpenalty=2000 % Avoids last line of paragraph on next page
\brokenpenalty=9000 % Avoids hyphenation across a page break
\hyphenpenalty=90 % Penalty for automatic hyphenation
\exhyphenpenalty=130 % Penalty for breaking after a dash or explicit hyphen
\doublehyphendemerits=900000 % Avoids hyphenation on consecutive lines
...
Vol-de-mort Le-strange Gil-deroy Car-michael Con-stan-tina Scour-gify
Alo-ho-mora Mun-dun-gus Hogs-meade Ros-sen-dale Nym-pha-dora
Ver-i-ta-serum Tre-lawney Az-ka-ban Poly-juice Sirius basi-lisk
Phi-neas McKin-non Filius Quiri-nus whom-ever}
